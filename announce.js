...
<https://github.com/andrew-templeton/vaxxie/blob/master/README-ES.md#no-warranty-for-any-purpose|NO HAY GARANTÍA PARA NINGÚN PROPÓSITO>, <https://github.com /andrew-templeton/vaxxie/blob/master/README-ES.md#you-are-solely-responsible-for-verifying-eligibility-of-the-people-you-use-to-book-this-for|TIENES LOS ÚNICOS RESPONSABLES DE VERIFICAR LA ELEGIBILIDAD DE LAS PERSONAS QUE USTED UTILIZA PARA RESERVAR ESTO>, <https://github.com/andrew-templeton/vaxxie/blob/master/README-ES.md#no-representations-of-medical- asesoramiento-asesoramiento-legal-o-declaraciones-de-hechos | NO HAY DECLARACIONES DE ASESORAMIENTO MÉDICO, ASESORAMIENTO LEGAL O DECLARACIONES DE HECHO>, <https://github.com/andrew-templeton/vaxxie/blob/master/README-ES.md # not-fit-for-use-by-minors-or-dependnts | NO ADECUADO PARA MENORES O DEPENDIENTES>, <https://github.com/andrew-templeton/vaxxie/blob/master/README-ES.md # fair-use | USO JUSTO>, <https://github.com/andrew-templeton/vaxxie/blob/master/README-ES.md#may-shut-down-at-the-sole- discreción de los operadores | PUEDE APAGARSE A LA ÚNICA DISCRECIÓN DE OPE RATORS>`
          }
        }
      ]
    }
